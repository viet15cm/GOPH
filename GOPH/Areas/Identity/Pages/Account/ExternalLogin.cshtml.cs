...
namespace GOPH.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        private readonly ISendMailServices _emailSender;
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        var isSendEmail = await _emailSender.SendMailAsync(mailContent);

                        ErrorMessage = isSendEmail ? "Gửi email thành công !!" : "Gửi Email thất bại !!";
